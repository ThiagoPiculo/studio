            ...
            <AlertDialog open={isDeleteConfirmOpen} onOpenChange={setIsDeleteConfirmOpen}>
                 <AlertDialogContent>
                    <AlertDialogHeader>
                        ...
                        <AlertDialogDescription>
                            Esta ação é permanente e irreversível. Todos os membros serão removidos e os heróis desta aliança retornarão aos seus espaços "Cuidar Solo". Para confirmar, digite o nome exato (até as letras em caixa alta e acentos, se tiver) da aliança abaixo.
                        </AlertDialogDescription>
                    </AlertDialogHeader>
                    <div className="py-2">
