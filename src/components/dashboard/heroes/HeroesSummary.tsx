...
import type { ChildProfile, UserProfile, MissionTemplate, RewardTemplate, MissionInstance, SchoolScheduleEntry } from "@/lib/types";
...
interface ContextData {
    context: {
        id: string;
        name: string;
        role?: 'Personal' | 'Owner' | 'Co-Owner' | 'Guardian' | 'Mentor' | 'Specialist';
    };
